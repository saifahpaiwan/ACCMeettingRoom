...
<head>
    ...
    <!-- shortcut icon -->
    <link rel="icon" href="{{ asset('/favicon-meta.ico') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('/favicon-meta.ico') }}" type="image/x-icon">
        ...
        <div class="navbar-custom">
            ...
            <div class="logo-box">
                <a href="{{ route('home') }}" class="logo text-center">
                    <span class="logo-lg">
                        <img src="{{ asset('/favicon.ico') }}" height="40" style="border: 1px solid #FFF; border-radius: 3px;">
                    </span>
                    <span class="logo-sm">
                        <img class="rounded-circle" src="{{ asset('/favicon-meta.ico') }}" width="40" height="40">
                    </span>
                </a>
            </div>
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);" data-original-title="" title="">
                                <i class="fe-grid"></i>
                                <span> PMS ห้องพัก </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul class="nav-second-level mm-collapse" aria-expanded="false">
                                <li>
                                    <a href="{{ route('home') }}">
                                        <span> ปฏิทิน Booking </span>
                                    </a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level mm-collapse" aria-expanded="false">
                                ...
                                <li>
                                    <a href="javascript: void(0);">
                                        <span> จัดการร้านอาหาร/โต๊ะ </span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav-second-level mm-collapse" aria-expanded="false">
                                ...
                                <li>
                                    <a href="{{ route('bos') }}">
                                        <span> บัญชีลูกหนี้ (AR) </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript: void(0);">
                                        <span> ใบเบิก/ขอซื้อ </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript: void(0);">
